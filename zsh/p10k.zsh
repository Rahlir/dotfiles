# Generated by Powerlevel10k configuration wizard on 2023-05-24 at 17:44 CEST.
# Customized by Tadeas Uhlir
...
() {
  ...
  local gruv_orange='#d65d0e'
  if [[ $THEMEBG == 'light' ]]; then
      typeset -g POWERLEVEL9K_THEMEBG=light
      local gruv_brightorange='#af3a03'
      local gruv_bg4='#a89984'
      local gruv_bg3='#bdae93'
      local gruv_fg4='#7c6f64'
      local gruv_fg3='#665c54'
  else
      typeset -g POWERLEVEL9K_THEMEBG=dark
      local gruv_brightorange='#fe8019'
      local gruv_bg4='#7c6f64'
      local gruv_bg3='#665c54'
      local gruv_fg4='#a98894'
      local gruv_fg3='#bdae93'
  fi
  ...
  # Connect left prompt lines with these symbols.
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX="%F{$gruv_bg3}╭─"
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX="%F{$gruv_bg3}├─"
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX="%F{$gruv_bg3}╰─"
  # Connect right prompt lines with these symbols.
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_SUFFIX="%F{$gruv_bg3}─╮"
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_SUFFIX="%F{$gruv_bg3}─┤"
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_SUFFIX="%F{$gruv_bg3}─╯"
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=$gruv_bg3
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VIVIS,VIOWR}_FOREGROUND=9
  # Color depends on background
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VICMD_FOREGROUND=$gruv_brightorange
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local  untracked='%6F'   # aqua foreground
    ...
    (( VCS_STATUS_NUM_STAGED     )) && res+=" ${clean}${(g::)POWERLEVEL9K_VCS_STAGED_ICON}${VCS_STATUS_NUM_STAGED}"
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND=$gruv_orange
  # Custom icon.
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_VISUAL_IDENTIFIER_EXPANSION='󱤳'

  ######################[ nnn: nnn shell (https://github.com/jarun/nnn) ]#######################
  # Nnn shell color.
  typeset -g POWERLEVEL9K_NNN_FOREGROUND=12
  # Custom icon.
  typeset -g POWERLEVEL9K_NNN_VISUAL_IDENTIFIER_EXPANSION='󱗁'

  ###########################[ vim_shell: vim shell indicator (:sh) ]###########################
  # Vim shell indicator color.
  typeset -g POWERLEVEL9K_VIM_SHELL_FOREGROUND=10
  # Custom icon.
  typeset -g POWERLEVEL9K_VIM_SHELL_VISUAL_IDENTIFIER_EXPANSION=' '

  ###########[ timewarrior: timewarrior tracking status (https://timewarrior.net/) ]############
  # Timewarrior color.
  typeset -g POWERLEVEL9K_TIMEWARRIOR_FOREGROUND=14
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=$gruv_fg3
